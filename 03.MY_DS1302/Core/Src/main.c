...
extern void pc_command_processing(void); // uart2.c : 명령어 처리
extern void DS1302_Init(void);           // ds1302.c : 초기화
extern void DS1302_read(void);  // ds1302.c : 1초마다 출력
/* USER CODE END PFP */
